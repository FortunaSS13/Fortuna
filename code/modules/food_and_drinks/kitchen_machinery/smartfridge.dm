...
/obj/machinery/smartfridge/bottlerack/alchemy_rack/accept_check(obj/item/O)
	if(istype(O, /obj/item/reagent_containers/pill/patch/healingpowder) || istype(O, /obj/item/reagent_containers/glass/bottle/primitive) || istype(O, /obj/item/reagent_containers/pill/patch/bitterdrink))
		return TRUE
	return FALSE
// -------------------------
