...
/obj/item/reagent_containers/food/snacks/meat/slab/human
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/cannibalnutriment = 3, /datum/reagent/consumable/cooking_oil = 2) //Meat has fats that a food processor can process into cooking oil
