...
/obj/item/clothing/suit/jacket/miljacket
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10)
...
/obj/item/clothing/suit/hooded/wintercoat/rd
	...
	icon_state = "coatrd"
	item_state = "coatrd"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 15, "bio" = 5, "rad" = 5, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/hooded/wintercoat/ce
	...
	icon_state = "coatce"
	item_state = "coatce"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 30, "fire" = 35, "acid" = 45)
...
/obj/item/clothing/suit/flakjack
	...
	resistance_flags = NONE
	armor = list("melee" = 5, "bullet" = 5, "laser" = 0, "bomb" = 20, "bio" = 0, "rad" = 0, "acid" = -15) //nylon sucks against acid
	mutantrace_variation = STYLE_DIGITIGRADE|STYLE_NO_ANTHRO_ICON
