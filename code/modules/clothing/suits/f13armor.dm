...
/obj/item/clothing/suit/armor/f13/combat/mk2/raider
	...
	desc = "(V) An old set of reinforced combat armor with some parts supplanted with painspike armor. It seems less protective than a mint-condition set of combat armor."
