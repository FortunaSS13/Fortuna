...
/obj/item/clothing/suit/f13/mfp //Mad Max 1 1979 babe!
	name = "MFP jacket"
	desc = "Main Force Patrol leather jacket.<br>Offbeat."
	icon_state = "mfp"
	item_state = "hostrench"
...
/obj/item/clothing/suit/f13/lonesome
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 25, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/f13/duster
	...
	icon_state = "duster"
	item_state = "det_suit"
	armor = list("melee" = 15, "bullet" = 10, "laser" = 20, "energy" = 0, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/f13/autumn //Based of Colonel Autumn's uniform.
	...
	item_state = "autumn"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 15, "bullet" = 15, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/f13/followers
	...
	item_state = "labcoat"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 20, "energy" = 10, "bomb" = 0, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/suit/hooded/cloak/shunter
	...
	slowdown = -0.20
	armor = list("melee" = 45, "bullet" = 35, "laser" = 25, "energy" = 10, "bomb" = 30, "bio" = 20, "rad" = 20, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/hooded/cloakhood/shunter
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 25, "energy" = 10, "bomb" = 25, "bio" = 20, "rad" = 20, "fire" = 30, "acid" = 0)
	heat_protection = HEAD
	resistance_flags = FIRE_PROOF | ACID_PROOF
