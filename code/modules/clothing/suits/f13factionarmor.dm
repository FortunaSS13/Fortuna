...
/obj/item/clothing/suit/armor/f13/raider
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/exile
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 40, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 20)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/f13/raider/raidercombat
	...
	armor = list("melee" = 35, "bullet" = 25, "laser" = 15, "energy" = 30, "bomb" = 50, "bio" = 50, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/raider/raidermetal
	...
	armor = list("melee" = 60, "bullet" = 45, "laser" = 46, "energy" = 35, "bomb" = 50, "bio" = 50, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.2
...
/obj/item/clothing/suit/armor/f13/legion
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 10, "bomb" = 16, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/legion/heavy
	...
	slowdown = -0.1
	armor = list("melee" = 50, "bullet" = 40, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/slavelabor
	...
	armor = list("melee" = 20, "bullet" = 10, "laser" = 5, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 10, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/vet/orator
	...
	icon_state = "legheavy"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/utilityvest
	...
	icon = 'icons/fallout/clothing/suits_utility.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/suit_utility.dmi'
	armor = list("melee" = 10, "bullet" = 15, "laser" = 10, "energy" = 5, "bomb" = 10, "bio" = 10, "rad" = 20, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reinforced
	...
	armor = list("melee" = 20, "bullet" = 40, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/mantle/reinforced
	...
	armor = list("melee" = 20, "bullet" = 40, "laser" = 15, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/labcoat
	...
	armor = list("melee" = 15, "bullet" = 25, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/captain
	...
	armor = list("melee" = 30, "bullet" = 50, "laser" = 15, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/lieutenant
	...
	armor = list("melee" = 25, "bullet" = 45, "laser" = 15, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/scout
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/scout/veteran
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/scout/officer
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/ncr_dressjack
	...
	armor = list("melee" = 10, "bullet" = 5, "laser" = 5, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/rangerrig
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	slowdown = -0.1
...
/obj/item/clothing/suit/armor/f13/rangercombat
	...
	item_state = "ranger"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 45, "bullet" = 45, "laser" = 30, "energy" = 40, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/ncrcfjacket
	...
	armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 0, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/headscribe
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 60, "bomb" = 36, "bio" = 50, "rad" = 69, "fire" = 10, "acid" = 70)
...
/obj/item/clothing/suit/armor/f13/town/mayor
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 15, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 35, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/town/sheriff
	...
	armor = list("melee" = 60, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/town/commissioner
	...
	item_state = "armor"
	armor = list("melee" = 40, "bullet" = 50, "laser" = 30, "energy" = 30, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/lightcloak
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 30, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 15, "bio" = 50, "rad" = 35, "fire" = 50, "acid" = 100)
	slowdown = -0.14
...
/obj/item/clothing/suit/armor/f13/tribe_armor
	...
	armor = list("melee" = 30, "bullet" = 10, "laser" = 10, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100)
	allowed = list(/obj/item/gun, /obj/item/kitchen, /obj/item/twohanded, /obj/item/claymore, /obj/item/melee/onehanded, /obj/item/twohanded/spear, /obj/item/melee/smith, /obj/item/melee/smith/twohand)
...
/obj/item/clothing/suit/armor/f13/riot/vault
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
