...
/obj/item/clothing/head/helmet/space/hardsuit/ancient
	...
	item_state = "anc_helm"
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 0, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 75, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/shielded/syndi
	...
	item_state = "syndie_helm"
	hardsuit_type = "syndi"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 5, "energy" = 15, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 30)
