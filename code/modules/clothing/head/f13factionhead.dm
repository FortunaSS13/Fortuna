...
/obj/item/clothing/head
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0)
...
/obj/item/clothing/head/helmet
	...
	icon_state = "helmet"
	item_state = "helmet"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50)
	flags_inv = HIDEEARS
...
/obj/item/clothing/head/helmet/f13/raider
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/raider/arclight
	...
	item_state = "arclight"
	visor_flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE
	armor = list("melee" = 25, "bullet" = 20, "laser" = 10, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
	flash_protect = 2
	tint = 0.5
...
/obj/item/clothing/head/helmet/f13/raider/blastmaster
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 20, "energy" = 25, "bomb" = 90, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 25)
...
/obj/item/clothing/head/helmet/f13/raider/psychotic
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 10, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/head/helmet/f13/fiend
	...
	icon_state = "fiend"
	item_state = "fiend"
	armor = list("melee" = 30, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 16, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/fiend_reinforced
	...
	icon_state = "fiend"
	item_state = "fiend"
	armor = list("melee" = 40, "bullet" = 30, "laser" = 20, "laser" = 20, "energy" = 10, "bomb" = 16, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/raidermetal
	...
	can_toggle = TRUE
	armor = list("melee" = 45, "bullet" = 40, "laser" = 46, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 30, "fire" = 20, "acid" = 0)
	slowdown = 0.2
...
/obj/item/clothing/head/helmet/f13/raidercombathelmet
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 25, "energy" = 35, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/helmet/enclave/peacekeeper
	...
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 35, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/helmet/enclave/officer
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 35, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/legion
	...
	lefthand_file = ""
	righthand_file = ""
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 16, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 50
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/legion/prime
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/vet
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/venator
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/recruit/decan
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/heavy
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 60, "rad" = 20, "fire" = 75, "acid" = 10)
...
/obj/item/clothing/head/helmet/f13/legion/heavy/attack_self(mob/user)
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/vet/decan
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 20, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/centurion
	...
	armor = list("melee" = 70, "bullet" = 50, "laser" = 35, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/rangercent
	...
	armor = list("melee" = 65, "bullet" = 50, "laser" = 30, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/palacent
	...
	armor = list("melee" = 70, "bullet" = 60, "laser" = 50, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/legate
	...
	armor = list("melee" = 75, "bullet" = 65, "laser" = 55, "energy" = 40, "bomb" = 45, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	flags_inv = HIDEEARS|HIDEEYES|HIDEHAIR
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/combat/legion
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 35, "energy" = 60, "bomb" = 25, "bio" = 60, "rad" = 60, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/mk2/legion
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 45, "energy" = 40, "bomb" = 39, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/f13/ncr
	...
	armor = list("melee" = 15, "bullet" = 35, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	strip_delay = 50
...
/obj/item/clothing/head/f13/ncr_flapcap
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	icon_state = "ncr_flapcap"
	item_state = "ncr_flapcap"
...
/obj/item/clothing/head/beret/ncr
	...
	armor = list("melee" = 25, "bullet" = 45, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/ncr_recon/worn
	...
	icon_state = "ncr_recon_beret"
	item_state = "ncr_recon_beret"
	armor = list("melee" = 25, "bullet" = 40, "laser" = 10, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/ncr_scout
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/ncr_scout_lt
	...
	icon_state = "scoutberet"
	item_state = "scoutberet"
	armor = list("melee" = 45, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/ncr_sapper
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/ncr_sof
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/f13/ncr_campaign
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/f13/trailranger
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/ncr
	...
	armor = list("melee" = 30, "bullet" = 45, "laser" = 35, "energy" = 60, "bomb" = 25, "bio" = 60, "rad" = 60, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/mk2/ncr
	...
	icon_state = "ncr_helmet"
	item_state = "ncr_helmet"
	armor = list("melee" = 40, "bullet" = 60, "laser" = 45, "energy" = 40, "bomb" = 39, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat
	...
	icon_state = "ranger"
	item_state = "ranger"
	armor = list("melee" = 45, "bullet" = 45, "laser" = 30, "energy" = 50, "bomb" = 39, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat/desert/whiskey
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/rangercombat/eliteriot/reclaimed
	...
	icon_state = "desert_ranger"
	item_state = "desert_ranger"
	armor = list("melee" = 40, "bullet" = 45, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 30, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEHAIR|HIDEFACIALHAIR|HIDEFACE
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 40, "energy" = 45, "bomb" = 60, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/initiate
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 45, "energy" = 60, "bomb" = 25, "bio" = 60, "rad" = 60, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/initiate/mk2
	...
	icon_state = "brotherhood_helmet"
	item_state = "brotherhood_helmet"
	armor = list("melee" = 45, "bullet" = 45, "laser" = 60, "energy" = 40, "bomb" = 39, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/f13/boscap
	...
	icon_state = "boscap"
	item_state = "boscap"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
	strip_delay = 20
...
/obj/item/clothing/head/f13/town
	...
	item_state = "dethat"
	flags_inv = HIDEHAIR
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 30, "fire" = 80, "acid" = 0)

/obj/item/clothing/head/f13/town/mayor
	name = "mayoral tricorn"
	desc = "A tricorn in the desert.  Stranger things have happened."
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 35, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/f13/town/deputy
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 35, "fire" = 80, "acid" = 0)

/obj/item/clothing/head/f13/town/sheriff
	name = "sheriff hat"
	desc = "A black cowboy hat with a snakeskin band."
	icon_state = "sheriffhat"
	armor = list("melee" = 60, "bullet" = 50, "laser" = 35, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
	
/obj/item/clothing/head/f13/town/commissioner
	name = "commissioner's hat"
	desc = "A blue hat with a silver badge"
	icon_state = "policehelm"
	armor = list("melee" = 40, "bullet" = 50, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/f13/det_hat_alt
	...
	item_state = "fedora"
	flags_inv = HIDEHAIR
	armor = list("melee" = 25, "bullet" = 30, "laser" = 20, "energy" = 10, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/khan
	...
	icon_state = "khan"
	item_state = "khan"
	armor = list("melee" = 30, "bullet" = 20, "laser" = 15, "energy" = 20, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	slowdown = 0.1
	flags_inv = HIDEEARS|HIDEHAIR
	strip_delay = 20
...
/obj/item/clothing/head/helmet/f13/deathskull
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 25, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 10, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/wayfarer/hunter
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 10, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/wayfarer/antler
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 0, "bomb" = 20, "bio" = 70, "rad" = 10, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/wayfarer/shamanblue
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 10, "energy" = 20, "bomb" = 20, "bio" = 70, "rad" = 10, "fire" = 20, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/head/helmet/f13/wayfarer/shamanred
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 70, "rad" = 10, "fire" = 20, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/head/helmet/f13/wayfarer/chief
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	actions_types = list(/datum/action/item_action/toggle)
	visor_flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	flags_inv = HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/head/helmet/f13/combat/wayfarer/tribe_helmet
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/head/helmet/f13/wayfarer/pa_helmet
	...
	armor = list("melee" = 40, "bullet" = 45, "laser" = 40, "energy" = 50, "bomb" = 40, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/riot/vaultsec
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 5, "bomb" = 5, "bio" = 2, "rad" = 0, "fire" = 50, "acid" = 50)
...
/obj/item/clothing/head/helmet/riot/vaultsec/vc
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 40, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/head/hardhat/ncr
	...
	flags_inv = HIDEEARS
	dog_fashion = null
	armor = list("melee" = 25, "bullet" = 35, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	strip_delay = 50
...
/obj/item/clothing/head/helmet/f13/khan/fullhelm
	...
	armor = list("melee" = 30, "bullet" = 35, "laser" = 25, "energy" = 20, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	strip_delay = 20
...
/obj/item/clothing/head/donor/enclave
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/enclave
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 75, "bomb" = 70, "bio" = 80, "rad" = 80, "fire" = 80, "acid" = 50)
...
/obj/item/clothing/head/helmet/f13/envirosuit
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 5,"energy" = 10, "bomb" = 10, "bio" = 100, "rad" = 100, "fire" = 50, "acid" = 100)
	strip_delay = 60
