...
/obj/item/clothing/head/helmet/f13/combat
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 35, "energy" = 60, "bomb" = 25, "bio" = 60, "rad" = 60, "fire" = 60, "acid" = 0, "wound" = 0)
	strip_delay = 50
...
/obj/item/clothing/head/helmet/f13/rangerbroken
	...
	armor = list("melee" = 70, "bullet" = 35, "laser" = 30, "energy" = 50, "bomb" = 39, "bio" = 20, "rad" = 20, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/helmet/knight/f13/metal
	...
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	armor = list("melee" = 45, "bullet" = 40, "laser" = 45, "energy" = 20, "bomb" = 16, "bio" = 0, "rad" = 0)
...
/obj/item/clothing/head/helmet/f13/metalmask
	...
	can_toggle = 1
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 40, "bomb" = 40, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/metalmask/mk2
	...
	armor = list("melee" = 30, "bullet" = 36, "laser" = 40, "energy" = 50, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	slowdown = 0.05
...
/obj/item/clothing/head/helmet/f13/power_armor/vaulttec
	...
	armor = list("melee" = 70, "bullet" = 70, "laser" = 55, "energy" = 50, "bomb" = 48, "bio" = 60, "rad" = 50, "fire" = 80, "acid" = 0, "wound" = 40)
	armor_block_chance = 40
...
/obj/item/clothing/head/helmet/f13/power_armor/vaulttecta
	...
	armor = list("melee" = 65, "bullet" = 65, "laser" = 50, "energy" = 50, "bomb" = 48, "bio" = 60, "rad" = 50, "fire" = 80, "acid" = 0, "wound" = 40)
	slowdown = 0.1
...
/obj/item/clothing/head/helmet/f13/tribal
	...
	item_state = "tribal"
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 10, "fire" = 0, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	strip_delay = 30
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/vaquerohat
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 30, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/wastewarhat
	...
	icon_state = "wastewar"
	item_state = "wastewar"
	armor = list("melee" = 25, "bullet" = 5, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/brahmincowboyhat
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 25, "energy" = 15, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 15)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/rustedcowboyhat
	...
	armor = list("melee" = 23, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 15)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/f13/police
	...
	item_state = "fedora"
	armor = list("melee" = 10, "bullet" = 15, "laser" = 0, "energy" = 0, "bomb" = 25, "bio" = 0, "rad" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/f13/riderw
	...
	icon_state = "riderw"
	item_state = "riderw"
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 15, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 15)
...
/obj/item/clothing/head/welding/f13/fire
	...
	item_state = "welding"
	tint = 1
	armor = list("melee" = 15, "bullet" = 10, "laser" = 5, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/atombeliever
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 45, "bomb" = 55, "bio" = 65, "rad" = 100, "fire" = 60, "acid" = 20)
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/f13/flatranger
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 30, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/herbertranger
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEHAIR|HIDEFACIALHAIR|HIDEFACE
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	resistance_flags = LAVA_PROOF | FIRE_PROOF
	dynamic_hair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/marlowhat
	...
	armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 0, "fire" = 50, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/f13/ranger_hat
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 15, "bomb" = 0, "bio" = 0, "rad" = 70, "fire" = 70, "acid" = 15)
	flags_inv = HIDEEARS|HIDEHAIR
