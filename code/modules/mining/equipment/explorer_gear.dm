...
/obj/item/clothing/suit/hooded/explorer/seva
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 10, "energy" = 45, "bomb" = 35, "bio" = 75, "rad" = 75, "fire" = 100, "acid" = 50)
...
/obj/item/clothing/head/hooded/explorer/seva
	...
	item_state = "seva"
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 45, "bomb" = 35, "bio" = 75, "rad" = 75, "fire" = 100, "acid" = 50)
	resistance_flags = FIRE_PROOF | GOLIATH_WEAKNESS
...
/obj/item/clothing/suit/hooded/explorer/exo
	...
	armor = list("melee" = 55, "bullet" = 5, "laser" = 5, "energy" = 40, "bomb" = 40, "bio" = 40, "rad" = 40, "fire" = 35, "acid" = 35)
