...
/datum/admins/proc/spawn_atom(object as text)
	...
	to_chat(user,"<span class='notice'><font size=1>Syntax: 'object : amount' \n example: wrench:50 will open a search for 'wrench', and then spawn 50 of your selection.</font></span>")
