...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_NO_CONSTRUCTION" = TRAIT_NO_CONSTRUCTION,
	...
	//	"TRAIT_POOR_AIM" = TRAIT_POOR_AIM,
		...
		"TRAIT_LITTLE_LEAGUES_1" = TRAIT_LITTLE_LEAGUES_1,
		"TRAIT_LITTLE_LEAGUES_2" = TRAIT_LITTLE_LEAGUES_2,
		"TRAIT_LITTLE_LEAGUES_3" = TRAIT_LITTLE_LEAGUES_3,
		"TRAIT_BAD_CRAFTING_1" = TRAIT_BAD_CRAFTING_1,
		"TRAIT_BAD_CRAFTING_2" = TRAIT_BAD_CRAFTING_2,
		"TRAIT_REVERSE_BLOODY_MESS" = TRAIT_REVERSE_BLOODY_MESS,
