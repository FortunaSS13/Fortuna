...
/obj/machinery/telecomms/bus/preset_three
	id = "Bus 3"
	network = "tcommsat"
	freq_listening = list(FREQ_SECURITY, FREQ_COMMAND, FREQ_VAULT, FREQ_NCR, FREQ_BOS, FREQ_KHAN, FREQ_DEN, FREQ_TOWN, FREQ_LEGION, FREQ_RANGER)
	autolinkers = list("processor3", "security", "command", "den","vault", "ncr", "bos", "khan", "town", "legion", "ranger")
