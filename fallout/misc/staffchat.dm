...
/datum/admins/proc/event_panel()
	...
	dat += "<b>Event Coordinator's Terminal</b><br>"
	dat += "<b>_______________________________</b><br><br>"

	dat += "<br><font size=2>Be sure to be as specific as you can be with the spawn commands.</font><br>"
	...
	dat += "<br><font size=2>Enables build mode. Use this instead of spawning 500 things by hand please.</font><br><br>"
	dat += "<b>_______________________________</b><br><br>"
	dat += "<font size=3><A href='?src=[REF(src)];[HrefToken()];toggle_invis=1'>Toggle Own Invisibility</a></font>"
	dat += "<br><font size=1>Makes you invisible if you are alive.<br><br></font>"
